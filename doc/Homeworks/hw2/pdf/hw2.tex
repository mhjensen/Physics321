...
%% doconce format latex hw2.do.txt --minted_latex_style=trac --latex_admon=paragraph --no_mako
%%
...
\begin{center}
{\bf Homework 2, due January 27 (Midnight)${}^{}$} \\ [0mm]
\end{center}
...
\begin{itemize}
\item 2a (3pt)  Identify the forces acting on the parachuter and draw a free-body diagram of the parachuter before the person has pulled the cord.

\item 2b (3pt)  Identify the forces acting on the parachuter and draw a free-body diagram of the parachuter after the person has pulled the cord.
