...
\end{equation}
\begin{itemize}
\item \textbf{1k (5pt):} What is the characteristic time scale $\tau$, and what is its value for argon, which has $\sigma=$3.405Å (1Å=1E-10m), $m = 39.95u$ (with 1u=1.66E-27kg) and $\varepsilon=$1.0318E-2eV (1eV=1.602E-19J)?
\end{itemize}
