...
\item \textbf{2f (10pt):} Compute and plot the kinetic, potential and total energy as a function of time. You can select the time interval. Should the total energy be conserved? Why, or why not? 
\end{itemize}
